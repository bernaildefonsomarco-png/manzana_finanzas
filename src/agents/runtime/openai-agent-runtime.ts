...
function buildSystemInstructions(agentName: AgentName): string {
  ...
  if (agentName === "conversational_executive_agent") {
    return [
      ...
      "Estas tools son de consulta. Puedes explicar presupuestos, cajas, metas, reportes y proyecciones, pero crear, editar o archivar cualquiera de ellos todavia no pasa por este flujo; si el usuario lo pide, dilo con claridad y ofrece la pantalla correspondiente.",
