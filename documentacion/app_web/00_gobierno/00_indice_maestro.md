...
| 03 | `03_decisiones_producto_web.md` | vivo | 13 decisiones registradas al cierre de la Ola 1. |
...
| # | Documento | Estado |
|---|---|---|
| 20 | `20_arquitectura_motor_conversacional.md` | no iniciado |
| 21 | `21_contrato_de_canal_y_presentadores.md` | no iniciado |
| 22 | `22_grounding_evidencia_y_politica.md` | no iniciado |
| 23 | `23_runtime_ia_modos_costo_y_degradacion.md` | no iniciado |
